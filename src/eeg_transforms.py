...
class ToTensor(object):
    ...
    # use this for gradient reversal for emotion recognition
    # def __call__(self, sample):
    #     eeg, label_emo, label_sub = sample['eeg'], sample['label_emo'], sample['label_sub']
    ...
    #         label_emo = torch.LongTensor([label_emo])
    #         label_sub = torch.LongTensor([label_sub])
        
    #     if self.interface=='dict':
    #         return {'eeg': eeg, 'label_emo': label_emo,'label_sub':label_sub}
    #     elif self.interface=='unpacked_values':
    #         return eeg, label_emo, label_sub
