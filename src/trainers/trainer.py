                ...
                for split in splits:
                    ...
                    for batch in tqdm(loaders[split]):
                        ...
                        if split == 'train':
                            ...
                            hidden_dim = 256
                            std_range=(0.0, 1.0), phase_noise_magnitude_range=(0.0, 1.0),random_state=42
                            bs, n_c, n_t = inputs.shape
                            all_views = torch.zeros(bs, 3, hidden_dim)
                            for i in range(3):
